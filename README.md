...
<hr>เมื่อรันโปรแกรมแล้ว จะได้คำว่า
This is text 1.
This is text 2.
This is text 3.
...
<hr> การใส่ { } ให้ใส่ค่าข้างในเหมือนเป็นการใส่ตำแหน่งของค่านั้น
<hr>
<hr>
<hr>
<hr>
###คำถาม 5.2  ถ้ามีการใช้ตัวเลขใน { } ที่กระโดด เช่น {0} {2} {3} จะใช้งานได้หรือไม่ อย่างไร จงอธิบาย
<hr>ใช้งานได้ การใส่ { } ค่าข้างในเหมือนเป็นการใส่ตำแหน่งของค่านั้น ต้องเพิ่มจำนวนข้างหลังด้วย
<hr>
<hr>
<hr>
<hr>
